...
| `prior_cesarean_count` | Number of prior cesarean deliveries | int8 | 2005–2024 | partial | 2005–2013: `RF_CESARN@325-326` (revised-cert only; 30.7% populated in 2005 ramping to 90.2% in 2013 with cert adoption); 2014–2024: `RF_CESARN@332-333` (~96–100% coverage). 0–30 = count, 99→null. Null for 1990–2004. Matches `prior_cesarean` coverage. |
