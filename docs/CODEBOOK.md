...
| `certificate_revision` | Certificate revision (1989 vs 2003) | string | 1990–2024 | full | `unrevised_1989` (1990–2013), `revised_2003` (2003–2023), `unknown` (2007–2013 when indeterminate) |
...
| `smoking_intensity_max_recode6` | Max smoking intensity during pregnancy (recode6) | int8 | 1990–2024 | partial | 1990–2002: `CIGAR6`; 2003–2013: `CIG_REC6` + trimester counts; 2014+: `CIG1_R`/`CIG2_R`/`CIG3_R` |
...
| `diabetes_any` | Diabetes (any type) | int8 | 1990–2024 | partial | 1990–2002: `DIABETES` (Y/N/unknown); 2003–2013: `URF_DIAB`; 2014+: `RF_GDIAB`/`RF_PDIAB` via `URF_DIAB` |
| `hypertension_chronic` | Chronic hypertension | int8 | 1990–2024 | partial | 1990–2002: `CHYPER`; 2003+: `URF_CHYPER` |
| `hypertension_gestational` | Pregnancy-associated hypertension | int8 | 1990–2024 | partial | 1990–2002: `PHYPER`; 2003+: `URF_PHYPER` |
...
| `father_age` | Father's age (single years) | int16 | 1990–2024 | partial | 1990–2002: `DFAGE`; 2003+: `FAGEREC11` or `FAGECOMB`. `99` → null |
| `birth_facility` | Birth facility type | string | 1990–2024 | partial | 1990–2002: `BIRPLA`; 2003–2013: `PLDEL`/`UBFACIL`; 2014+: `BFACIL`. Values: `hospital`, `birth_center`, `clinic_other`, `home` |
| `attendant_at_birth` | Attendant at birth | int8 | 1990–2024 | partial | 1990–2002: `ATTEND`; 2003+: `ATTEND`. 1=MD, 2=DO, 3=CNM, 4=other midwife, 5=other, 9=unknown |
...
| `prior_cesarean` | Prior cesarean delivery | bool | 1990–2024 | partial | 1990–2002: `DCSEZD`; 2003+: `RF_CESAR` / `URF_CESAR`. Y→true, N→false, U/blank→null |
...
| `father_race_ethnicity_5` | Father race/ethnicity (5-category) | string | 1990–2024 | partial | 1990–2002: `ORRACEF`; 2003–2013: `FRACEHISP` (same codes as ORRACEF); 2014+: `FRACEHISP` (different coding: 1-6=NH race groups, 7=Hispanic). Values: `Hispanic`, `NH_white`, `NH_black`, `NH_other`, null |
...
| `cause_recode_130` | 130 Infant Cause of Death recode | int16 | 1–130 or null | NCHS 130-cause recode. Null for survivors |
