...
- **Medical risk factors**: diabetes, chronic hypertension, gestational hypertension, prior cesarean delivery and prior cesarean count (both revised-certificate-only; populated 2005+ with adoption ramp, ~96–100% coverage from 2014+)
